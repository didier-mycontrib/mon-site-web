...
export class QcmService extends GenericRestCrudService<Qcm> {
  ...
  public settingPublicAndPrivateBaseUrl(): void {
    ...
    this.privateBaseUrl = "./qcm-api/private/role_admin/qcm" ; //avec ng serve --proxy-config proxy.conf.json
  }

  public findQcmFromCriteria(mode:string=null,org:string=null,code:string=null):Observable<Qcm[]>{
  ...
  public postQcmChoices(qcmId:string,choices: ResponseChoices[],qcmPerformer:QcmPerformer,mode:string=null):Observable<PostChoicesResponse>{
    let url : string = "./qcm-api/public/qcm_choices";
    let postChoicesRequest = new  PostChoicesRequest();
    postChoicesRequest.qcmId=qcmId;
    postChoicesRequest.mode=mode;
...
export class QcmResultsService extends GenericRestCrudService<QcmResults> {
  ...
  public settingPublicAndPrivateBaseUrl(): void {
    this.privateBaseUrl = "./qcm-api/private/role_admin/qcm_results" ; //avec ng serve --proxy-config proxy.conf.json
