...
export class AdminQcmComponent implements OnInit , GenericCrudAbstractContextHelper<Qcm>{
  ...
  public genericCrudContext : GenericCrudContext<Qcm> = null;
  ...
  onSupprimerObject(): void {
    this.qcmService.deleteEntityObjectServerSide(this.genericCrudContext.selectedObject._id)
  ...
  ajustSolutionsInQcm(qcm : Qcm): void{
    ...
    for(let i=0;i<qcm.nbQuestions;i++){
        ...
        qcm.solutions[i].num=qcm.questions[i].num;
